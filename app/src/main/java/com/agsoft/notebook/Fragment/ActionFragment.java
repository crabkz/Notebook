...
public class ActionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View inflate = inflater.inflate(R.layout.fragment_action, container, false);
    ...
    private class Madapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View v = View.inflate(getContext(), R.layout.fragment_item, null);
            TextView tv = (TextView) v.findViewById(R.id.tv_content);
            if (i == 0) {
                tv.setTextColor(Color.argb(255,255,255,255));
            }else
           // tv.setTextColor(Color.argb(255, (int) (48-i*30/19.0), (int) (63-i*48/19.0), (int) (159-i*60/19.0)));
            tv.setTextColor(Color.argb(255,255,255,255));
            return v;
        }
    }
